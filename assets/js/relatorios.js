...
(function(global){
  ...
  var _state = { tab: 'executivo', ordExec: { med:'custo_desc', prest:'custo_desc', opme:'valor_desc' }, buscaExec: { med:'', prest:'', opme:'' }, ordProc: 'qtd_desc', buscaProc: '', filtroRisco: '', filtroAtend: '', periodo: { de:'', ate:'' } };

...
(function(global){
  ...
  var STATUS = ['Em análise','Aguardando complemento','Aguardando documentação','Em junta médica','Cotação de OPME','Analisada','Em correção pelo prestador','Liberada','Negada','Encerrada','Sem parametrização'];
  ...
  var GUIAS_RAW = [
    ...
    {numero:'506294837',benId:'B5',presS:'P2',presE:'P2',solicitante:'PATRICIA MENEZES SOUZA',tipo:'Exame',natureza:'Ambulatorial',regime:'Eletivo',fluxoId:'F9',status:'Sem parametrização',origem:'Emissão guias',uti:false,opme:false,dut:false,anexos:false,prio:'Baixa',procs:['40601161'],pacs:[],mm:[],dt:[],risco:'baixo',obs:'Exame sem parametrização — exige cadastro de regras.'},
